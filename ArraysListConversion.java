...
public class ArraysListConversion {
	...
	public static void main(String args[]) {
		...
		list.remove(0);// list is converted to an array. therefore remove opr on list resizes the array..and hence nooprsupp exception
